...
class TREADScanViewHolder extends RecyclerView.ViewHolder {
    TextView deviceName;
    TextView deviceAddress;
    LinearLayout container;

    public TREADScanViewHolder(View itemView) {
        super(itemView);
...
public class TREADScanAdapter extends RecyclerView.Adapter<TREADScanViewHolder> {
    Context context;
    ...
    public TREADScanAdapter(ArrayList<BluetoothDevice> deviceArrayList, Context context) {
    ...
    @NonNull
    @Override
    public TREADScanViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.listitem_device, parent, false);
        return new TREADScanViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull TREADScanViewHolder holder, int position) {
