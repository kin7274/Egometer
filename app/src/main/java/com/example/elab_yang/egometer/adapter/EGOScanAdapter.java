...
class EGOScanViewHolder extends RecyclerView.ViewHolder {
    TextView deviceName;
    TextView deviceAddress;
    LinearLayout container;

    public EGOScanViewHolder(View itemView) {
        super(itemView);
...
public class EGOScanAdapter extends RecyclerView.Adapter<EGOScanViewHolder> {
    Context context;
    ...
    public EGOScanAdapter(ArrayList<BluetoothDevice> deviceArrayList, Context context) {
    ...
    @NonNull
    @Override
    public EGOScanViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.listitem_device, parent, false);
        return new EGOScanViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull EGOScanViewHolder holder, int position) {
