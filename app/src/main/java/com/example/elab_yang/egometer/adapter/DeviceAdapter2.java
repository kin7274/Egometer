...
import com.example.elab_yang.egometer.activity.DeviceControlActivity;
import com.example.elab_yang.egometer.activity.TimelineActivity;
...
public class DeviceAdapter2 extends RecyclerView.Adapter<DeviceAdapter2.ViewHolder> {
    ...
    public DeviceAdapter2(Context context, List<Device> deviceList) {
    ...
    @NonNull
    @Override
    public DeviceAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Paper.init(context);
        this.parent = parent;
